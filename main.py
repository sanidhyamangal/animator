...
from data_handler import get_anime_dataset  # to get anime dataset

# load dataset
train_dataset = get_anime_dataset("images", 256)
...
def train(dataset, epochs):
    ...
    for epoch in range(1, epochs + 1):
        ...
        generate_and_save_images(generator, "image_at_{:4d}".format(epoch),
                                 seed)
